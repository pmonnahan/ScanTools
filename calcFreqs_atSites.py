...
def calcFreqs(input_directory, output_directory, output_filename, sites_file, pops):
    ...
    for pop in pop_list:
        with open(input_directory + pop + ".table.repol.txt") as pop_data:
...
if __name__ == '__main__':  # Used to run code from command line
    ...
    j1 = calcFreqs(args.i, args.o, args.of, args.s, args.pops)
